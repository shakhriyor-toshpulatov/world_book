...
class Author(models.Model):
    ...
    date_of_death = models.DateField(help_text='Дата смерти',
...
class Book(models.Model):
    ...
    genre = models.ForeignKey(Genre, on_delete=models.CASCADE,
                              help_text='Выберите жанр книги', verbose_name='Жанр книги', null=True)
    language = models.ForeignKey(Language, on_delete=models.CASCADE,
                                 help_text='Выберите язык книги', verbose_name='язык книги', null=True)
    author = models.ManyToManyField(Author, help_text='Выборите автор книги',
                                    verbose_name='автор книги', null=True)
    summary = models.TextField(max_length=1000,
                               help_text="Введите краткое описание", verbose_name='Аннотация книги')
...
class Status(models.Model):
    name = models.CharField(max_length=20, help_text="Должно содержать 13 символов", verbose_name="ISBN книги")
